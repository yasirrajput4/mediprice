...
import { LayoutDashboard, ListChecks, CalendarDays, LogOut, Menu, X } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { to: '/admin/services', icon: <ListChecks size={18} />, label: 'Services & Prices' },
...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      {/* Sidebar */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-60 bg-gray-900 text-white flex flex-col transition-transform duration-200
