...
export default function HospitalPage() {
  ...
  const { data: services = [] } = useQuery({
    ...
    queryFn: () =>
      hospitalsApi.services(id, { category: activeCategory || undefined }),
    enabled: !!id,
  });
          ...
          <div className="flex-1">
              ...
              <div>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {hospital.is_verified && (
                    <Badge color="green">✓ NABH Verified</Badge>
                  )}
                </div>
            ...
            <div className="flex flex-wrap gap-4 mt-4 text-sm text-gray-600">
              <span className="flex items-center gap-1.5">
                <Clock size={14} /> Avg wait: ~{hospital.avg_wait_min} min
              </span>
              {hospital.phone && (
                <a
            ...
            {filteredServices.map((svc) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 flex-shrink-0">
                  <PriceTag
                    price={svc.price}
                    discountedPrice={svc.discounted_price}
                    size="md"
                  />
                  <button
                    type="button"
                    onClick={() =>
                      navigate(`/book/${hospital.id}/${svc.service_id}`)
                    }
                ...
                <div key={r} className="flex items-center gap-2 text-xs">
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-1.5">
                    <div
                      ...
                      style={{
                        width: `${r === Math.round(hospital.rating) ? 60 : r < Math.round(hospital.rating) ? 20 : 10}%`,
                      }}
                    />
                  </div>
                </div>
