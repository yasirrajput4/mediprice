...
export default function AdminDashboardPage() {
  ...
  const statCards = [
    ...
    },
    {
      ...
      label: "This Month",
      value: stats?.bookings_month ?? 0,
      bg: "bg-emerald-50",
    },
    {
      icon: <IndianRupee size={20} className="text-violet-500" />,
      label: "Monthly Revenue",
      value: `₹${Number(stats?.revenue_month ?? 0).toLocaleString("en-IN")}`,
      bg: "bg-violet-50",
    },
    {
              ...
              >
                <div>
                  ...
                  <div className="text-xs text-gray-400">
                    {b.service_name} · {String(b.slot_time).substring(0, 5)}
                  </div>
                </div>
